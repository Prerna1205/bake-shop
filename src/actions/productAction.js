...
export const getAdminProducts = (token) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get(`${apiBaseUrl}/api/admin/products`,config);
...
export const createProduct = (productData,token) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${apiBaseUrl}/api/admin/product/new`, productData, config);
...
export const deleteReview = (reviewId, productId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`/api/admin/reviews?id=${reviewId}&productId=${productId}`);
